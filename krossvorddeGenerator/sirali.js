...
var fs = require('fs');
  fs.readFile('doneinternet2', function(err, data) {
    ...
    for(let prob = 0; prob < 1; prob++) {
      //Balcklist
      let BList = ["SCHEICH","HEIDEN-","INTERESSENT","VERWARNUNG","SACK","VERB","SONDE","HABEN","LEBER","ÜBEL","FLANKE","DUNG","SPORN","ESPE","GROG","AMME","FUNKSTREIFE","OLLE","ABBITTE","PFLAUME","POLIT-","INFORMANT","ANSTALT","MÜNDEL","HÜTTENSCHUH","MACHE","ANSTALTEN","KOLLIER","","","",""];
      let BlackSet = {};
      let CAVABLAR = [];
      for(let i = 0; i < BList.length; i++)BlackSet[(BList[i])]=1;
      let SAYLI = [[],[],[],[],[],[],[],[],[],[],[],[]];
      let SAY = [[],[],[],[],[150],[150],[150],[150],[150],[150],[150],[150]]
      for(let i = 4; i <= 11; i++) {
        let say = 0;
